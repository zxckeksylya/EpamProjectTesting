    ...
    <div class="card-body">
        <form action="<c:url value="/system_of_testing"/>" method="POST" class="needs-validation action-form"
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">текст ответа</span>
                    </div>
                    <input type="text" class="form-control" placeholder="название ответа" required maxlength="50"
                           id="text_of_answer"
                           name="text_of_answer">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-light">Добавить ответ</button>
            </div>
        </form>
    </div>
</div>
