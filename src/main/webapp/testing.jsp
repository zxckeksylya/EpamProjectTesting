...
<div class="card bg-dark text-white form-client-list">
  ...
  <div class="card-body">
    <table class="table table-light table-stripped" id="answers">
      ...
      <c:forEach items="${quests}" var="questItem" varStatus="currentNumberQuest">
        <tr>
          <th scope="row"><c:out value="${currentNumberQuest.count}"/></th>
          <td><c:out value="${questItem.textOfQuest}"/></td>
          <td>
            <c:forEach items="${answers}" var="answerItem" varStatus="currentNumberAnswer">
              <tr>
                <th scope="row"><c:out value="${currentNumberAnswer.count}"/></th>
                <td> <c:out value="${answerItem.textOfAnswer}"/></td>
              </tr>
            </c:forEach>
          </td>
          <td>
